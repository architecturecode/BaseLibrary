...
object SettingUtil {
    ...
    fun getColor(context: Context): Int {
        ...
        val defaultColor = ContextCompat.getColor(context, R.color.design_default_color_on_primary)
...
//    }
    ...
    fun getColorStateList(context: Context): ColorStateList {
        val colors = intArrayOf(getColor(context), ContextCompat.getColor(context, R.color.design_default_color_on_primary))
